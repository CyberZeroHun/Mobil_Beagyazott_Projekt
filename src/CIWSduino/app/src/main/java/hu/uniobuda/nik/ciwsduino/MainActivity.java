    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ffo.add(
                new FulFragmenObject(
                        new UltrahangFragment(),
                        this.getResources().getString(R.string.ultrahang),
        ...
        ffo.add(
                new FulFragmenObject(
                        new ManualisVezerlesFragment(),
                        this.getResources().getString(R.string.manualisvezerles),
                        ContextCompat.getDrawable(getApplicationContext(), R.drawable.ic_manualisvezerles_feher)

                )
        );
        ffo.add(
                new FulFragmenObject(
                        new AktivitasokFragment(),
                        this.getResources().getString(R.string.aktivitasok),
                        ContextCompat.getDrawable(getApplicationContext(), R.drawable.ic_aktivitasok_feher)

                )
        );
        ffo.add(
                new FulFragmenObject(
                        new BeallitasokFragment(),
                        this.getResources().getString(R.string.beallitasok),
                        ContextCompat.getDrawable(getApplicationContext(), R.drawable.ic_beallitasok_feher)
