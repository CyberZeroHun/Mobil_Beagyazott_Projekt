...
import static hu.ciwsduino.ultrasonic.GlobalisKonstansok.*;
...
public class UltrasonicView extends View {
    ...
    private void beallitas(Context context, AttributeSet attrs){
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                ...
                0, 0);
        try {
            tavolsag = a.getInteger(R.styleable.UltrasonicView_tavolsag, MAX_TAV);
            tavolsag_osztas = a.getInteger(R.styleable.UltrasonicView_tavolsag_osztok, ALAP_TAV_OSZTAS);
            szog = a.getInteger(R.styleable.UltrasonicView_szog, MAX_SZOG);
